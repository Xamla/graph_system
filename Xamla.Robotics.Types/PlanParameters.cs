...
namespace Xamla.Robotics.Types
{
    ...
    public class PlanParameters
    {
        ...
        /// </summary>
        /// TODO: ADDED_DOCUMENTATION <param name="builder"> The builder which builds the <c>PlanParameters</c> object</param>
        /// TODO: ADDED_DOCUMENTATION <exception cref="System.ArgumentOutOfRangeException">Thrown when either <c>MaxVelocity</c> or <c>MaxAcceleration</c> does not match the <c>JointSet</c> size.</exception>
