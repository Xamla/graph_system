...
namespace Xamla.Robotics.Types
{
    ...
    {
        /// <summary>
        /// Creates a new <c>ICartesianPath</c> by appending the given ICartesianPath, to the current one.
        /// </summary>
        /// <param name="other">An ICartesianPath that should be appended to the current one.</param>
        /// <returns>A new <c>ICartesianPath</c> containing the current ICartesianPath followed by the given one.</returns>
        ICartesianPath Concat(ICartesianPath other);

        /// <summary>
        /// Creates a new <c>ICartesianPath</c>, by prepending the given collection of poses to the current path.
        /// </summary>
        /// <param name="source">The collection of <c>Pose</c> instances that should be prepended to the current path.</param>
        /// <returns>A new <c>ICartesianPath</c> containing the given poses followed by the present poses.</returns>
        ICartesianPath Prepend(IEnumerable<Pose> source);

        /// <summary>
        /// Creates a new <c>ICartesianPath</c>, by appending the given collection of poses to the current path.
        /// </summary>
        /// <param name="source">The collection of <c>Pose</c> instances that should be appended to the current path.</param>
        /// <returns>A new <c>ICartesianPath</c> containing the present poses followed by the given poses.</returns>
        ICartesianPath Append(IEnumerable<Pose> source);

        /// <summary>
        /// Creates a new <c>ICartesianPath</c> containing the poses in the range of [<paramref name="startIndex"/>, <paramref name="endIndex"/>].
        /// </summary>
        ...
        /// <returns>A new <c>ICartesianPath</c> containing the poses in the range of [<paramref name="startIndex"/>, <paramref name="endIndex"/>].</returns>
        ICartesianPath Sub(int startIndex, int endIndex);

        /// <summary>
        /// Creates a new <c>ICartesianPath</c> by applying the given transform function to the poses in the current path.
        /// </summary>
        ...
        /// <returns>A new <c>ICartesianPath</c> which is the result of applying the transform function to the current path.</returns>
