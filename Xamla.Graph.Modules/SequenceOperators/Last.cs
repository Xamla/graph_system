...
{
    [Module(ModuleType = "Xamla.Sequence.Operators.Last")]
    public class Last
        : ModuleBase
    {
        ...
        public Last(IGraphRuntime runtime)
            : base(runtime)
        {
        ...
        {
            return input.LastAsync(null, cancel).ResultAsObject();
        }
    ...
    [Module(ModuleType = "Xamla.Sequence.Operators.LastOrDefault")]
        ...
        : ModuleBase
    {
        ...
        public LastOrDefault(IGraphRuntime runtime)
            : base(runtime)
        {
            this.inputPin = AddInputPin("Input", PinDataTypeFactory.FromType(typeof(ISequence<>)), PropertyMode.Never);
            this.outputPin = AddOutputPin("Output", PinDataTypeFactory.Create<object>());
        ...
        private Task<object> EvaluateInternal<T>(ISequence<T> input, CancellationToken cancel)
        {
            return input.LastOrDefaultAsync(null, cancel).ResultAsObject();
        }
