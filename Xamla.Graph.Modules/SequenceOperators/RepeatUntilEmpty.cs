...
{
    [Module(ModuleType = "Xamla.Sequence.Operators.RepeatUntilEmpty")]   
    public class RepeatUntilEmpty
        : ModuleBase
    {
        ...
        public RepeatUntilEmpty(IGraphRuntime runtime)
            : base(runtime)
        {
