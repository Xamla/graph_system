...
namespace Xamla.Robotics.Motion
{
    ...
    public interface IMoveGroup : IDisposable
    {
        ...
        /// <summary>
        /// Get a reference to an object implementing <c>IEndEffector</c>. 
        /// </summary>  
        /// <param name="endEffectorName">Name of the end effector The default end effector is used when null.</param>  
        /// <returns>Returns the object implementig <c>IEndEffector</c> associated with <c>endEffectorName</c>.</returns>  
        ...
        /// <summary>
        /// Get the current <c>Pose</c> instance of an end effector.  
        /// </summary>  
        /// <param name="endEffectorName">Name of the <c>IEndEffector</c> instance. The default end effector is used when null.</param>  
        /// <returns>Returns the current <c>Pose</c> instance of the end effector associated with <c>endEffectorName</c>.</returns>  
