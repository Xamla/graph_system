...
namespace Xamla.Robotics.Motion
{
    ...
    public static class PoseExtensions
    {
        ...
        public static xamlamoveit.JointPathPoint ToJointPathPointMessage(this JointValues jointValues) =>
            new xamlamoveit.JointPathPoint
            {
                positions = jointValues.ToArray()
            };

        /// <summary>
        /// Converts a <c>JointValues</c> object into a <c>xamlamoveit.JointValuesPoint</c> message object.
        /// </summary>
        /// <param name="jointValues">The <c>JointValues</c> object ot be converted.</param>
        /// <returns>Returns an instance of <c>xamlamoveit.JointValuesPoint</c>.</returns>
        public static xamlamoveit.JointValuesPoint ToJointValuesPointMessage(this JointValues jointValues)
            => new xamlamoveit.JointValuesPoint { joint_names = jointValues.JointSet.ToArray(), positions = jointValues.ToArray() };

        /// <summary>
        /// Converts a <c>xamlamoveit.JointValuesPoint</c> message object into a <c>JointValues</c> object.
        /// </summary>
        /// <param name="jointValuesPoint">The <c>xamlamoveit.JointValuesPoint</c> message object ot be converted.</param>
        /// <returns>Returns an instance of <c>JointValues</c>c>.</returns>
        public static JointValues ToJointValues(this xamlamoveit.JointValuesPoint jointValuesPoint)
            => new JointValues(new JointSet(jointValuesPoint.joint_names), jointValuesPoint.positions);
        ...
        /// <summary>
        /// Extends type <c>xamlamoveit.JointPathPoint</c> with a method <c>ToJointValues</c>, which creates a <c>JointValues</c>
        /// instance using a specified joint set.
        /// </summary>
        ...
        public static JointValues ToJointValues(this xamlamoveit.JointPathPoint point, JointSet jointSet) =>
            new JointValues(jointSet, point.positions);
        ...
        public static trajectory_msgs.JointTrajectoryPoint ToJointTrajectoryPointMessage(this JointTrajectoryPoint point) =>
            new trajectory_msgs.JointTrajectoryPoint()
            {
